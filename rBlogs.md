...
-------------------------------  |  ----------------------------  | ------------------------------
**Model Explanation with BMuCaret Shiny Application using the IML and DALEX Packages** | Opensource Complex Shiny app | [Data Science Plus](https://datascienceplus.com/model-explanation-with-bmucaret-shiny-application-using-the-iml-and-dalex-packages/)
